...
Disminuir el tiempo promedio de respuesta a los tickets en un 30% durante los primeros seis meses de operación mediante la automatización y optimización de procesos.
\subsubsection{Mejorar la Satisfacción del Cliente}
Aumentar el índice de satisfacción del cliente en un 25% mediante una gestión más eficiente de los tickets, evaluado a través de encuestas post-servicio.

\subsubsection{Capacitar al Personal de Soporte}
Capacitar al 100% del personal de la empresa en el uso del nuevo sistema antes del lanzamiento, mediante al menos tres sesiones de formación.
